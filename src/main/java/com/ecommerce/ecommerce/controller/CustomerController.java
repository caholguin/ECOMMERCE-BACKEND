...
public class CustomerController {
    ...
    @PostMapping()
    public ResponseEntity<UserDTO> register(@RequestBody @Valid SaveUserDTO saveUserDTO){
        UserDTO registerUser = authenticationService.registerCustomer(saveUserDTO);
